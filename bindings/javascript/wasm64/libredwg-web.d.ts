...
interface EmbindModule {
  ...
  dwg_object_get_tio(_0: bigint): bigint;
  dwg_object_get_type(_0: bigint): number;
  dwg_object_get_supertype(_0: bigint): number;
  dwg_object_get_fixedtype(_0: bigint): number;
  dwg_object_get_handle(_0: bigint): number;
  dwg_obj_obj_to_object(_0: bigint): bigint;
  dwg_obj_generic_to_object(_0: bigint): bigint;
  dwg_object_to_object(_0: bigint): bigint;
  dwg_object_to_object_tio(_0: bigint): bigint;
  dwg_object_to_entity(_0: bigint): bigint;
  dwg_object_to_entity_tio(_0: bigint): bigint;
  dwg_object_object_get_tio(_0: bigint): bigint;
  dwg_object_object_get_objid(_0: bigint): number;
  dwg_object_object_get_ownerhandle(_0: bigint): bigint;
  dwg_object_object_get_handle(_0: bigint): bigint;
  dwg_object_object_get_num_reactors(_0: bigint): number;
  dwg_object_object_get_reactors(_0: bigint): bigint;
  dwg_object_entity_get_ownerhandle(_0: bigint): bigint;
  dwg_object_entity_get_xdicobjhandle(_0: bigint): bigint;
  dwg_object_entity_get_handle(_0: bigint): bigint;
  dwg_object_entity_get_line_weight(_0: bigint): number;
  dwg_object_entity_get_entmode(_0: bigint): number;
  dwg_object_entity_get_invisible(_0: bigint): number;
  dwg_object_entity_get_plotstyle_flags(_0: bigint): number;
  dwg_object_entity_get_material_flags(_0: bigint): number;
  dwg_object_entity_get_shadow_flags(_0: bigint): number;
  dwg_object_entity_has_full_visualstyle(_0: bigint): number;
  dwg_object_entity_has_face_visualstyle(_0: bigint): number;
  dwg_object_entity_has_edge_visualstyle(_0: bigint): number;
  dwg_object_entity_get_num_reactors(_0: bigint): number;
  dwg_object_entity_get_reactors(_0: bigint): bigint;
  dwg_ref_get_absref(_0: bigint): number;
  dwg_ref_get_object(_0: bigint): bigint;
  dwg_ref_get_handle(_0: bigint): number;
  dwg_ref_object(_0: bigint, _1: bigint): bigint;
  dwg_ref_object_relative(_0: bigint, _1: bigint, _2: bigint): bigint;
  dwg_ref_object_silent(_0: bigint, _1: bigint): bigint;
  dwg_resolve_handleref(_0: bigint, _1: bigint): number;
  dwg_entity_owner(_0: bigint): bigint;
  dwg_get_version_type(_0: bigint): number;
  dwg_get_codepage(_0: bigint): number;
  dwg_get_num_classes(_0: bigint): number;
  dwg_block_control(_0: bigint): bigint;
  dwg_model_space_ref(_0: bigint): bigint;
  dwg_paper_space_ref(_0: bigint): bigint;
  dwg_model_space_object(_0: bigint): bigint;
  dwg_paper_space_object(_0: bigint): bigint;
  dwg_get_layer_count(_0: bigint): number;
  dwg_get_layer_index(_0: bigint, _1: bigint): bigint;
  dwg_get_num_objects(_0: bigint): number;
  dwg_get_object_num_objects(_0: bigint): number;
  dwg_class_is_entity(_0: bigint): number;
  dwg_obj_is_control(_0: bigint): number;
  dwg_obj_is_table(_0: bigint): number;
  dwg_obj_is_subentity(_0: bigint): number;
  dwg_obj_has_subentity(_0: bigint): number;
  dwg_obj_is_3dsolid(_0: bigint): number;
  dwg_obj_is_acsh(_0: bigint): number;
  dwg_get_num_entities(_0: bigint): number;
  dwg_get_entity_index(_0: bigint, _1: bigint): bigint;
  dwg_get_entity_layer(_0: bigint): bigint;
  dwg_next_object(_0: bigint): bigint;
  dwg_next_entity(_0: bigint): bigint;
  get_first_owned_entity(_0: bigint): bigint;
  get_next_owned_entity(_0: bigint, _1: bigint): bigint;
  get_first_owned_subentity(_0: bigint): bigint;
  get_next_owned_subentity(_0: bigint, _1: bigint): bigint;
  get_first_owned_block(_0: bigint): bigint;
  get_last_owned_block(_0: bigint): bigint;
  get_next_owned_block(_0: bigint, _1: bigint): bigint;
  get_next_owned_block_entity(_0: bigint, _1: bigint): bigint;
  dwg_get_first_object(_0: bigint, _1: Dwg_Object_Type): bigint;
  dwg_get_next_object(_0: bigint, _1: Dwg_Object_Type, _2: number): bigint;
  dwg_resolve_jump(_0: bigint): bigint;
  dwg_free(_0: bigint): void;
  dwg_abandon(_0: bigint): void;
  dwg_free_object(_0: bigint): void;
  dwg_new_ref(_0: bigint): bigint;
  dwg_dup_handleref(_0: bigint, _1: bigint): bigint;
  dwg_supports_eed(_0: bigint): number;
  dwg_supports_obj(_0: bigint, _1: bigint): number;
  dwg_add_object(_0: bigint): number;
  dwg_get_object(_0: bigint, _1: number): bigint;
  dwg_absref_get_object(_0: bigint, _1: number): bigint;
  dwg_resolve_handle(_0: bigint, _1: bigint): bigint;
  dwg_resolve_handle_silent(_0: bigint, _1: bigint): bigint;
  dwg_next_handle(_0: bigint): bigint;
  dwg_next_handseed(_0: bigint): bigint;
  dwg_add_handle(_0: bigint, _1: number, _2: bigint, _3: bigint): number;
  dwg_add_handleref(_0: bigint, _1: number, _2: bigint, _3: bigint): bigint;
  dwg_add_handleref_free(_0: number, _1: bigint): bigint;
  dwg_obj_get_handle_value(_0: bigint): bigint;
  dwg_ref_get_handle_value(_0: bigint): bigint;
  dwg_ref_get_handle_absolute_ref(_0: bigint): bigint;
  dwg_object_entity_get_ltype_flags(_0: bigint): number;
  dwg_object_entity_get_ltype_scale(_0: bigint): number;
  dwg_model_x_min(_0: bigint): number;
  dwg_model_x_max(_0: bigint): number;
  dwg_model_y_min(_0: bigint): number;
  dwg_model_y_max(_0: bigint): number;
  dwg_model_z_min(_0: bigint): number;
  dwg_model_z_max(_0: bigint): number;
  dwg_page_x_min(_0: bigint): number;
  dwg_page_x_max(_0: bigint): number;
  dwg_page_y_min(_0: bigint): number;
  dwg_page_y_max(_0: bigint): number;
  dwg_object_get_dxfname(_0: bigint): string;
  is_dwg_entity(_0: EmbindString): boolean;
  is_dwg_object(_0: EmbindString): boolean;
  dwg_dynapi_header_set_value(_0: bigint, _1: EmbindString, _2: bigint, _3: boolean): boolean;
  dwg_dynapi_entity_set_value(_0: bigint, _1: EmbindString, _2: EmbindString, _3: bigint, _4: boolean): boolean;
  dwg_dynapi_common_set_value(_0: bigint, _1: EmbindString, _2: bigint, _3: boolean): boolean;
  dwg_dynapi_handle_name(_0: bigint, _1: bigint, _2: bigint): string;
  dwg_write_dxf(_0: EmbindString, _1: EmbindString): number;
  dwg_find_tablehandle(_0: bigint, _1: EmbindString, _2: EmbindString): bigint;
  dwg_find_tablehandle_index(_0: bigint, _1: number, _2: EmbindString): bigint;
  dwg_handle_name(_0: bigint, _1: EmbindString, _2: bigint): string;
  dwg_find_table_control(_0: bigint, _1: EmbindString): bigint;
  dwg_find_dictionary(_0: bigint, _1: EmbindString): bigint;
  dwg_find_dicthandle(_0: bigint, _1: bigint, _2: EmbindString): bigint;
  dwg_find_dicthandle_objname(_0: bigint, _1: bigint, _2: EmbindString): bigint;
  dwg_find_table_extname(_0: bigint, _1: bigint): string;
  dwg_variable_dict(_0: bigint, _1: EmbindString): string;
  dwg_section_type(_0: EmbindString): DWG_SECTION_TYPE;
  dwg_section_name(_0: bigint, _1: number): string;
  ...
  dwg_encrypt_SAT1(_0: number, _1: bigint, _2: bigint): string;
  dwg_object_name(_0: EmbindString, _1: bigint, _2: bigint, _3: bigint, _4: bigint): number;
  dwg_obj_layer_get_name(_0: bigint): string;
  dwg_obj_layer_set_name(_0: bigint, _1: EmbindString): number;
  dwg_obj_table_get_name(_0: bigint): string;
  dwg_ref_get_table_name(_0: bigint): string;
  dwg_ent_get_POINT2D(_0: bigint, _1: EmbindString): dwg_point_2d | null;
  dwg_ent_set_POINT2D(_0: bigint, _1: EmbindString, _2: dwg_point_2d | null): boolean;
  dwg_ent_get_POINT3D(_0: bigint, _1: EmbindString): dwg_point_3d | null;
  dwg_ent_set_POINT3D(_0: bigint, _1: EmbindString, _2: dwg_point_3d | null): boolean;
  dwg_ent_get_STRING(_0: bigint, _1: EmbindString): string;
  dwg_ent_set_STRING(_0: bigint, _1: EmbindString, _2: EmbindString): boolean;
  dwg_ent_get_UTF8(_0: bigint, _1: EmbindString): string;
  dwg_ent_set_UTF8(_0: bigint, _1: EmbindString, _2: EmbindString): boolean;
  dwg_ent_get_REAL(_0: bigint, _1: EmbindString): number;
  dwg_ent_set_REAL(_0: bigint, _1: EmbindString, _2: number): boolean;
  dwg_ent_get_INT16(_0: bigint, _1: EmbindString): number;
  dwg_ent_set_INT16(_0: bigint, _1: EmbindString, _2: number): boolean;
  dwg_ent_get_INT32(_0: bigint, _1: EmbindString): number;
  dwg_ent_set_INT32(_0: bigint, _1: EmbindString, _2: number): boolean;
  dwg_handle(_0: bigint): any;
  dwg_object_ref(_0: bigint): any;
  dwg_ptr_to_object_ref_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_object_ref_ptr_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_wchar_string_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_unsigned_char_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_signed_char_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_uint16_t_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_int16_t_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_uint32_t_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_int32_t_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_uint64_t_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_int64_t_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_double_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_point2d_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_point3d_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_point4d_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_ltype_dash_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_table_cell_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_hatch_defline_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_hatch_path_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_hatch_gradient_color_array(_0: bigint, _1: bigint): any;
  dwg_ptr_to_mline_vertex_array(_0: bigint, _1: bigint): any;
  dwg_object_get_name(_0: bigint): any;
  dwg_object_get_handle_object(_0: bigint): any;
  dwg_object_object_get_ownerhandle_object(_0: bigint): any;
  dwg_object_object_get_handle_object(_0: bigint): any;
  dwg_object_entity_get_ownerhandle_object(_0: bigint): any;
  dwg_object_entity_get_xdicobjhandle_object(_0: bigint): any;
  dwg_object_entity_get_handle_object(_0: bigint): any;
  dwg_object_entity_get_layer_object_ref(_0: bigint): any;
  dwg_object_entity_get_ltype_object_ref(_0: bigint): any;
  dwg_object_entity_get_color_object(_0: bigint): any;
  dwg_object_entity_get_xdata(_0: bigint): any;
  dwg_ref_get_handle_object(_0: bigint): any;
  dwg_dynapi_header_value(_0: bigint, _1: EmbindString): any;
  dwg_dynapi_entity_value(_0: bigint, _1: EmbindString): any;
  dwg_dynapi_common_value(_0: bigint, _1: EmbindString): any;
  dwg_dynapi_subclass_value(_0: bigint, _1: EmbindString, _2: EmbindString): any;
  dwg_entity_polyline_2d_get_numpoints(_0: bigint): any;
  dwg_entity_polyline_2d_get_points(_0: bigint): any;
  dwg_entity_polyline_2d_get_vertices(_0: bigint): any;
  dwg_entity_polyline_3d_get_numpoints(_0: bigint): any;
  dwg_entity_polyline_3d_get_points(_0: bigint): any;
  dwg_entity_polyline_3d_get_vertices(_0: bigint): any;
  dwg_entity_block_header_get_preview(_0: bigint): any;
  dwg_entity_get_preview(_0: bigint): any;
  dwg_entity_proxy_entity_get_entity_data(_0: bigint): any;
  dwg_entity_insert_get_attribs(_0: bigint): any;
  dwg_object_dictionary_get_texts(_0: bigint): any;
  dwg_read_file(_0: EmbindString): any;
  dwg_bmp(_0: bigint): any;
  dwg_get_class(_0: bigint, _1: number): any;
}
